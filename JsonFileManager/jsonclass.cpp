...
void JsonClass::SetValue1(int value)
{
    value_1 = value;
}

int JsonClass::GetValue1()
{
    return value_1;
}

void JsonClass::SetValue2(std::string value)
{
    value_2 = value;
}

std::string JsonClass::GetValue2()
{
    return value_2;
}

void JsonClass::SetValue3(int value)
{
    value_3 = value;
}

int JsonClass::GetValue3()
{
    return value_3;
}

void JsonClass::SetValue4(int value)
{
    value_4 = value;
}

int JsonClass::GetValue4()
{
    return value_4;
}
