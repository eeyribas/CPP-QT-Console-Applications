...
std::vector<unsigned char> UDPComm::Recv()
{
    ...
    if (UDPComm::server_select) {
        ...
        n = recvfrom(sock_fd, (char *)buffer, MAX_LINE, MSG_WAITALL, (struct sockaddr *) &cli_addr, &len);
    } else {
        socklen_t len = sizeof(serv_addr);
        n = recvfrom(sock_fd, (char *)buffer, MAX_LINE, MSG_WAITALL, (struct sockaddr *) &serv_addr, &len);
    }
