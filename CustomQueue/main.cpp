...
int main(int argc, char *argv[])
{
    ...
    std::cout << "Data Queue value 1 : " << get_data.value_1 << std::endl;
    std::cout << "Data Queue value 2 : " << get_data.value_2 << std::endl;
    std::cout << "Data Queue value 3 : " << get_data.value_3 << std::endl;
